      ...
      <div className="container mx-auto my-5 rounded-xl p-5 bg-[#90e0ef] min-h-[80vh] max-w-[30vw] ">
        ...
        <div className="addTodo my-5">
          ...
          <div className='flex flex-col w-full gap-4 justify-center items-center mt-4'>
            ...
            <input onChange={handleChange} value={todo} type="text" className=' rounded-md h-8 w-full' />
            <button onClick={handleAdd} disabled={todo.length <= 3} className='bg-[#48cae4] hover:bg-[#00b4d8] p-3 py-1 text-white rounded-md mx-6 text-sm font-bold disabled:bg-[#48cae4] w-full '> Save</button>
          </div>
        </div>
          ...
          {todos.map(item => {
            ...
            return (showFinished || !item.isCompleted) && <div key={item.id} className="todo flex justify-between  items-start mb-6">
              ...
              <div className="buttons text-center flex flex-col items-center h-full">
                <button className='bg-[#48cae4] hover:bg-[#00b4d8] p-3 py-1 text-white rounded-md mx-1 my-2 text-sm font-bold  ' onClick={(e) => handleEdit(e, item.id)}> Edit</button>

                <button className='bg-[#48cae4] hover:bg-[#00b4d8] p-3 py-1 text-white rounded-md mx-1  my-2 text-sm font-bold ' onClick={(e) => { handleDelete(e, item.id) }} >Delete</button>
